...
def print_welcome_message():
    ...
    print(Fore.GREEN + Style.BRIGHT + "Youtube: https://www.youtube.com/@EGY_Global1")
    # print(Fore.GREEN + Style.BRIGHT + "Github: https://github.com/Epic2030/Dotcoin")
    print(Fore.GREEN + Style.BRIGHT + "Join our tg channel for updates: https://t.me/RNG_Global")
    print(Fore.GREEN + Style.BRIGHT + "Tg group: @RNG_Global\n")
